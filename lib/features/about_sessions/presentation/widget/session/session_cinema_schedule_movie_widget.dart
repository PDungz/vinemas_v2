...
class SessionTitleCinemaMovie extends StatefulWidget {
  const SessionTitleCinemaMovie({
    super.key,
    required this.cinemaBand,
    required this.selectedDate,
    required this.selectedTimeInterval,
  ...
  @override
  State<SessionTitleCinemaMovie> createState() =>
      _SessionTitleCinemaMovieState();
}

class _SessionTitleCinemaMovieState extends State<SessionTitleCinemaMovie> {
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      '${session.chairStatuses.length}/${chairConfig.rowCount * chairConfig.seatsPerRow}'
                                                          .toString(),
                                                      style: Theme.of(context)
                                                          .textTheme
                                                          .bodySmall,
