...
class _SeatReservationPageState extends State<SeatReservationPage> {
  ...
  Widget build(BuildContext context) {
    return CustomLayout(
      appBar:
          SeatReservationAppBarWidget(movie: movie, sessionMovie: sessionMovie),
      body: Column(
        children: [
          Column(
            children: [
          ...
          Expanded(
            child: InteractiveViewer(
              ...
              child: GridView.builder(
                ...
                itemCount:
                    (chairConfig.seatsPerRow * chairConfig.rowCount) as int,
                itemBuilder: (context, index) {
                  int rowIndex = index ~/ chairConfig.seatsPerRow;
                  int seatNumber = (index % chairConfig.seatsPerRow as int) + 1;
                  ...
                  return InkWell(
                      ...
                      if (!sessionMovie.chairStatuses
                        ...
                        setState(() {
                          if (currentBooked
                            ...
                            currentBooked.remove('${row.name}$seatNumber');
                            if (chairConfig.chairTypes['regular']!
                                .contains(row.name)) {
                              setState(() {
                                currentPrice -=
                                    sessionMovie.seatPrices['regular'] as int;
                              });
                            } else if (chairConfig.chairTypes['vip']!
                                .contains(row.name)) {
                              setState(() {
                              ...
                              setState(() {
                                currentPrice -=
                                    sessionMovie.seatPrices['sweetBox'] as int;
                              });
                            }
                          } else {
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: currentBooked.contains('${row.name}$seatNumber')
